...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row"><label for="co_sec_subject">부 제목</label></th>
        <td><input type="text" name="co_sec_subject" value="<?php echo htmlspecialchars2($co['co_sec_subject']); ?>" id="co_sec_subject" required class="frm_input required" size="90"></td>
    </tr>
    <tr>
        <th scope="row">내용</th>
