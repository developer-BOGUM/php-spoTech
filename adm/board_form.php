...
<section id="anc_bo_basic">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="bo_sec_subject">부 게시판 제목</label></th>
            <td colspan="2">
                <input type="text" name="bo_sec_subject" value="<?php echo get_text($board['bo_sec_subject']) ?>" id="bo_sec_subject" class="frm_input" size="80" maxlength="120">
            </td>
        </tr>
        <tr>
...
<section id="anc_bo_design">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="bo_content_head">상단 이미지</label></th>
            <td>
