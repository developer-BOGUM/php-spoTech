...
$contextpath = 'http://106.242.160.150:10020';

$g5['title'] = $co['co_subject'];
$g5['sec_title'] = $co['co_sec_subject'];
if($co['type'] == 'content') {
    $g5['head_img'] = '<p><img src="'.$contextpath.'/data/content/'.$co['co_id'].'_h"/><br style="clear:both;"><br></p>';
}
