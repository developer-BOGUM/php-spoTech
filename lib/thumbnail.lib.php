...
function get_list_thumbnail($bo_table, $wr_id, $thumb_width, $thumb_height, $is_create=false, $is_crop=false, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3')
{
    ...
    $tname = thumbnail($filename, $filetype, $filepath, $filepath, $thumb_width, $thumb_height, $is_create, $is_crop, $crop_mode, $is_sharpen, $um_value);
...
function thumbnail($filename, $filetype, $source_path, $target_path, $thumb_width, $thumb_height, $is_create, $is_crop=false, $crop_mode='center', $is_sharpen=false, $um_value='80/0.5/3') {
    global $g5;
    ...
    $extensions = array(0 => 'mp4', 1 => 'gif', 2 => 'jpg', 3 => 'png', 18 => 'webp');

    if($filetype == "0") {
        $file_ext = $extensions[$filetype]; // 파일 확장자
    }
    else {
    ...
    if($file_ext == 'mp4') {
        $thumb_file = "$target_path/thumb-{$thumb_filename}.".$file_ext;
